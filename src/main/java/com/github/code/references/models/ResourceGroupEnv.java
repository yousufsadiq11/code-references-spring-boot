...
public class ResourceGroupEnv {
    ...
    @JsonCreator
    public ResourceGroupEnv(@JsonProperty("az_cost") Double az_cost, @JsonProperty("gcp_cost") Double gcp_cost, @JsonProperty("os_cost") Double os_cost, @JsonProperty("az_cn_cost") Double az_cn_cost, @JsonProperty("total_cost") Double total_cost) {
